...
export type GetRecipeIngredientAggregateType<T extends RecipeIngredientAggregateArgs> = {
    [P in keyof T & keyof AggregateRecipeIngredient]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateRecipeIngredient[P]> : Prisma.GetScalarType<T[P], AggregateRecipeIngredient[P]>;
};
...
type GetRecipeIngredientGroupByPayload<T extends RecipeIngredientGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<RecipeIngredientGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof RecipeIngredientGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], RecipeIngredientGroupByOutputType[P]> : Prisma.GetScalarType<T[P], RecipeIngredientGroupByOutputType[P]>;
}>>;
export type RecipeIngredientWhereInput = {
    ...
    amount?: Prisma.StringNullableFilter<"RecipeIngredient"> | string | null;
    order?: Prisma.IntFilter<"RecipeIngredient"> | number;
...
export type RecipeIngredientScalarWhereWithAggregatesInput = {
    ...
    amount?: Prisma.StringNullableWithAggregatesFilter<"RecipeIngredient"> | string | null;
    order?: Prisma.IntWithAggregatesFilter<"RecipeIngredient"> | number;
};
...
export type RecipeIngredientOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "recipeId" | "name" | "amount" | "order", ExtArgs["result"]["recipeIngredient"]>;
...
export type RecipeIngredientCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<RecipeIngredientFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface RecipeIngredientDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['RecipeIngredient'];
        meta: {
            name: 'RecipeIngredient';
        };
    };
     ...
     * })
    **/
    count<T extends RecipeIngredientCountArgs>(args?: Prisma.Subset<T, RecipeIngredientCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], RecipeIngredientCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends RecipeIngredientGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, RecipeIngredientGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetRecipeIngredientGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface RecipeIngredientFieldRefs {
    ...
    readonly amount: Prisma.FieldRef<"RecipeIngredient", 'String'>;
    readonly order: Prisma.FieldRef<"RecipeIngredient", 'Int'>;
}
/**
